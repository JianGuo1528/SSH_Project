...
<form name="icform" method="post">
    ...
    <div>
        <input type="checkbox" name="testData" value="100" title="hello">A&nbsp;
        <input type="checkbox" name="testData" value="200" title="hello">B&nbsp;
        <input type="checkbox" name="testData" value="300" title="hello">C&nbsp;
    </div>
</form>
<s:debug></s:debug>
</body>
